...
func generateClientExercises() []*physio.PhysioExercise {
	...
	defs := []exDef{
		...
		{"Hamstring Curls with Band",
			...
			rehab, knee, valg, bandLight, "6-7", 3, 12},
		{"Hip Thrust with Ball Squeeze",
			...
			strength, knee, valg, bw, "7-8", 3, 12},
		{"Clam Shell",
		...
		{"Knee Extension – Seated on Box",
			...
			strength, knee, valg, bw, "6-7", 3, 12},
		{"Single-Leg Jumps",
			...
			functional, knee, valg, bw, "8-9", 3, 8},
		...
		{"Shoulder Internal Rotation – Side Lying",
			...
			rehab, shoulder, kyph, bandLight, "6-7", 3, 12},
		...
		{"Shoulder Retraction with Band",
			...
			rehab, shoulder, kyph, bandLight, "5-6", 3, 12},
		...
		{"Hip Internal Rotation – Banded",
			...
			rehab, hip, lord, bandLight, "5-6", 3, 12},
		...
		{"Shoulder Abduction with Dumbbell",
			...
			strength, shoulder, kyph, bandLight, "6-7", 3, 12},
		...
		{"One Arm Banded Push",
			...
			strength, shoulder, kyph, bandMed, "6-7", 3, 12},
		{"One Arm Banded Pull",
